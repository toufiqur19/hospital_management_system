...
<section class="lg:ml-[15rem] mt-[5rem] bg-gray-900 w-auto h-auto text-white p-[2.5rem] rounded-md">
    ...
    <form class="space-y-4 md:space-y-6" action="#" enctype="multipart/form-data" method="POST">
        ...
        <div class="space-y-2 w-full">
            ...
            <input type="text" name="question" id="question" class="rounded-lg bg-transparent border-2 text-white w-full text-sm border-[#07ccec] p-2.5 outline-none" placeholder="enter your question">
        </div>
        <div class="space-y-2 w-full">
            <label for="">Answer</label>
            <input type="text" name="answer" id="answer" class="rounded-lg bg-transparent border-2 text-white w-full text-sm border-[#07ccec] p-2.5 outline-none" placeholder="enter your answer">
        </div>
        </div>
        <div class="lg:mt-10">
            <input type="file">
