...
<section class="lg:ml-[15rem] mt-[5rem] bg-gray-900 w-auto h-auto text-white p-[2.5rem] rounded-md">
    ...
    <form class="space-y-4 md:space-y-6" action="#" enctype="multipart/form-data" method="POST">
        ...
        <div class="space-y-2 w-full">
            ...
            <input type="number" name="star" id="star" class="rounded-lg bg-transparent border-2 text-white w-full text-sm border-[#07ccec] p-2.5 outline-none" placeholder="enter your star">
        </div>
        </div>
        <div class="space-y-2 w-full">
        ...
        <div class="space-y-2 w-full">
            ...
            <textarea name="comment" id="comment" class="rounded-lg bg-transparent border-2 text-white w-full text-sm border-[#07ccec] p-2.5 outline-none" placeholder="enter your comment"></textarea>
        </div>
        <div class="lg:mt-10">
            <input type="file">
        </div>
