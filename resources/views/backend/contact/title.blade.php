...
<section class="lg:ml-[15rem] mt-[5rem] bg-gray-900 w-auto h-auto text-white p-[2.5rem] rounded-md">
    <div class="flex justify-between">
        <h1 class="text-xl">Home / <span class="text-[#07ccec]">Contact Title</span></h1>
        <a href="{{route('title.create')}}" class="bg-[#07ccec] py-1.5 px-3 rounded-md text-gray-900 hover:bg-gray-700 hover:text-white duration-500">create</a>
    </div>
        ...
        <table class="w-full">
            <thead class="bg-gray-800">
                <tr>
                    ...
                    <th scope="col" class="py-4 px-3">Map</th>
