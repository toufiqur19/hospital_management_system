...
<section class="lg:ml-[15rem] mt-[5rem] bg-gray-900 w-auto h-auto text-white p-[2.5rem] rounded-md">
    ...
    <div class="flex justify-between">
        <h1 class="text-xl">Home / <span class="text-[#07ccec]">Carousel</span></h1>
        ...
        <table class="table-auto overflow-x-auto">
            <thead class="bg-gray-800">
                <tr>
                    ...
                    <th scope="col" class="py-4 px-3">Sort Description</th>
            ...
            <tbody>
                @foreach ($carousels as $carousel)
                    <tr class="bg-gray-700">
                        <td class="py-4 px-3">{{$carousel->title}}</td>
                        <td class="py-4 px-3">{{$carousel->sort_description}}</td>
                        <td class="py-4 px-3">
                            <img src="{{asset('/uploads/carousel/'.$carousel->image)}}" alt="" width="20" height="20">
                        </td>
